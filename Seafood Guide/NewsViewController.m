...
- (void)viewDidLoad
{
    ...
    UIImage * backgroundPattern = [UIImage imageNamed:@"whitey_@2X.png"];
    
    [self.view setBackgroundColor:[UIColor colorWithPatternImage:backgroundPattern]];
    
    
    UIGraphicsBeginImageContext(self.view.frame.size);
    [[UIImage imageNamed:@"whitey_@2X.png"] drawInRect:self.view.bounds];
...
//        self.detailNewsViewController = [[DetailNewsViewController alloc] initWithNibName:@"DetailNewsViewController" bundle:[NSBundle mainBundle]];
//    }
//    RSSItem *object = _objects[indexPath.row];
//    _detailNewsViewController.detailItem = object;
//    _detailNewsViewController.image = [imageArray objectAtIndex:indexPath.row];
//    [self.navigationController pushViewController:_detailNewsViewController animated:YES];
...
DetailNewsViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"detailview"];
    ...
    if (_detailNewsViewController == nil) {
        ...
        //self.detailNewsViewController = [storyboard instantiateViewControllerWithIdentifier:@"detailview"]; //[[DetailNewsViewController alloc] initWithNibName:@"DetailNewsViewController" bundle:[NSBundle mainBundle]];
    }
    //NSLog(@"test");
...
//                             cache:YES];
//    
//    [self.view addSubview:_detailNewsViewController.view];
//    [UIView commitAnimations];
}
